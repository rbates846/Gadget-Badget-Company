...
public class FundManagement {
	...
	public String insertFund(@FormParam("funderName") String name, @FormParam("fundResearch") String research,
			@FormParam("paymentType") String type, @FormParam("fundAmount") String amount,
			@FormParam("fundDesc") String Desc, @FormParam("fundDate") String date) {
